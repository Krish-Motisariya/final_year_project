<?php
    ...
    if(!$conn){
        ...
        $sql2 = "SELECT * FROM `tbl_data2` WHERE status=1";
...
<body>
    ...
    <div class="content">
        <a class="btn btn-dark float-end" href="add_app.php"><i class="fa-solid fa-plus"></i> Add App</a>
        <table id="appTable" class="display" style="width:100%">
            ...
            <?php while($data2 = mysqli_fetch_assoc($result2)){ ?>
                <tr>
                    ...
                    <!-- <td><?php echo $data2['descriptions']; ?></td> -->
                    <td><?php echo $data2['downloads']; ?></td>
                    <td>
                        <a href="rate_review.php?app_id=<?php echo $data2['data2_id']; ?>" class="btn btn-warning">Rate & Review <i class="fa-solid fa-comments"></i></a>
                    </td>
                    <td>
                        <a class="btn btn-info text-white" href="update_app.php?id=<?php echo $data2['data2_id']; ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a class="btn btn-danger text-white" href="delete_app.php?id=<?php echo $data2['data2_id']; ?>"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr><?php } ?>
            </tbody>
        </table>
